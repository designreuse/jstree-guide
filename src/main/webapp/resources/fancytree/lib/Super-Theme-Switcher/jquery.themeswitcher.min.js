 ...
 *
 */
(function(d){d.fn.themeswitcher=function(c){function f(b){if(null!==a.onselect)a.onselect();l.text(a.buttonpretext+" "+b.title);var h=[],c=b.url;c||(h=a.themepath+a.jqueryuiversion+"/jquery-ui.css/",c=h+b.name+"/jquery-ui.css",h=d('link[href^="'+h+'"]').first());h.length?h[0].href=c:d("<link/>").attr("type","text/css").attr("rel","stylesheet").attr("href",c).appendTo("head");d.cookie(a.cookiename,b.name,{expires:a.cookieexpires,path:a.cookiepath});e.find(".jquery-ui-switcher-title").text(a.buttonpretext+
